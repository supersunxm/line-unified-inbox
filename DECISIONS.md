...
Leave operational backfill date fields, coupon schedule datetimes, and fixed Google Review business-period selectors intact because they are not arbitrary reporting date ranges. Do not invent a `/replymessage` route absent from this checkout; keep that migration explicitly blocked pending its source location.
