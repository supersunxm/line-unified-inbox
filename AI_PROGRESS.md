...
- Next action: obtain the signed APK from the permanent-key GitHub Actions workflow, independently verify it, publish download metadata, and run frontend regression/build checks.
