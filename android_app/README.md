...
3. Configure Firebase for application ID `click.lineoppo.chat` and place the Firebase Android configuration at `android/app/google-services.json`. This file is deliberately ignored.
