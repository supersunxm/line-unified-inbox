...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  Future<void> _submit() async {
    ...
    try { await widget.auth.register(name: _name.text, email: _email.text, storeId: _storeId!, role: _role, password: _password.text); widget.onSubmitted(); }
