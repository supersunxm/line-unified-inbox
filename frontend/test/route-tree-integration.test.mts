...
const adminStoresPageCode = readFileSync(new URL("../src/app/admin/stores/page.tsx", import.meta.url), "utf8");
...
test("all workspace route entrypoints delegate through normalized authorization with matching section key", () => {
  ...
  assert.match(adminStoresPageCode, /AuthorizedWorkspace section="stores"/);
...
test("public store directory is accessible without AuthorizedWorkspace or login gate", () => {
