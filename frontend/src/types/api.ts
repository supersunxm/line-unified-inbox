...
export type GreetingTemplateStatus = "DRAFT" | "ACTIVE" | "INACTIVE" | "ARCHIVED";
export type GreetingSendPolicy = "FIRST_TIME_ONLY" | "ADD_AND_UNBLOCK";
export type GreetingExecutionStatus = "SUCCESS" | "SKIPPED" | "FAILED";
...
export type GreetingReadinessResponse = {
  templateId: string;
  templateName: string;
  usedVariables: string[];
  totalStores: number;
