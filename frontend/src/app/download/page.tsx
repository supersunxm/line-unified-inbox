    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-4 py-8 text-slate-900 transition-colors duration-150 sm:px-6 dark:bg-[#0b0d11] dark:text-slate-100">
      <div className="w-full max-w-md space-y-6">
        <div className="flex items-center justify-center gap-2.5">
          ...
          <span className="font-semibold text-base tracking-tight text-slate-900 dark:text-slate-100">OPPO LINE OA Chat</span>
        </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xl shadow-slate-200/50 sm:p-8 dark:border-slate-800/80 dark:bg-[#12151c] dark:shadow-none">
          ...
          <div className="mt-5 text-center">
            <h1 className="font-bold text-xl text-slate-900 tracking-tight sm:text-2xl dark:text-white">OPPO LINE OA Chat</h1>
          ...
          <div className="mt-5 rounded-xl border border-slate-100 bg-slate-50/80 p-4 text-xs dark:border-slate-800/80 dark:bg-slate-900/40">
            <h3 className="font-semibold text-slate-800 dark:text-slate-200">✨ มีอะไรใหม่ในเวอร์ชัน 1.0.7 (What&apos;s New in v1.0.7)</h3>
            <ul className="mt-2 space-y-1.5 text-slate-600 dark:text-slate-300">
              <li className="flex items-start gap-1.5"><span className="text-emerald-500 font-bold">•</span><span><strong>Improved Product Tagging Flow</strong>: ปรับปรุงขั้นตอนการ Tag สินค้าให้ราบรื่นและแม่นยำยิ่งขึ้น</span></li>
              <li className="flex items-start gap-1.5"><span className="text-emerald-500 font-bold">•</span><span><strong>Draft Selection Flow</strong>: ระบบเลือกสินค้าแบบ Draft (Select → Configure → Confirm → Save) ชัดเจนแบบ POS/CRM</span></li>
              <li className="flex items-start gap-1.5"><span className="text-emerald-500 font-bold">•</span><span><strong>Fixed Product Persistence After Confirmation</strong>: แก้ไขปัญหาสินค้าไม่แสดงหลังกดยืนยัน</span></li>
              <li className="flex items-start gap-1.5"><span className="text-emerald-500 font-bold">•</span><span><strong>Improved Product Name Display</strong>: ปรับปรุงการแสดงชื่อสินค้ายาวไม่ให้ล้นหน้าจอ</span></li>
              <li className="flex items-start gap-1.5"><span className="text-emerald-500 font-bold">•</span><span><strong>Improved CRM Multi-Product Tagging</strong>: เพิ่มความแม่นยำในการเก็บข้อมูลสินค้าหลายรายการพร้อมกัน</span></li>
            </ul>
          </div>

          <div className="mt-6">
            <a href={apkDownloadUrl} download={apkFileName} className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 py-3.5 font-semibold text-sm text-white shadow-md shadow-emerald-600/20 transition-all hover:bg-emerald-500 active:scale-[0.98] dark:bg-emerald-500 dark:hover:bg-emerald-400">
