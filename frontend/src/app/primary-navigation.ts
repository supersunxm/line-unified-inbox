export type PrimarySection = "home" | "dashboard" | "chats" | "main-oa" | "stores" | "store-360" | "admin-registrations" | "purchase-analytics" | "line-chat-health" | "follower-insights" | "friend-source-links" | "mass-messages" | "coupons" | "rich-menus" | "auto-responses" | "greeting-messages" | "google-review-kpi";
