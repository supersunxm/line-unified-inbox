    ...
    sections: [
      {
        ...
        bullets: [
          ...
          { label: "สถิติจำนวนวิดีโอและตัวชี้วัดสาธารณะ", text: "จำนวนวิดีโอรวมที่เผยแพร่บนบัญชี (Video Count) โดยระบบไม่เก็บหรือดาวน์โหลดไฟล์วิดีโอต้นฉบับ ไม่ขอสิทธิ์ video.list หรือสิทธิ์การโพสต์คอนเทนต์ (ไม่เก็บข้อมูลระดับรายวิดีโอ เช่น video views, video likes, comments หรือ shares)" },
      ...
      },
      {
        ...
        bullets: [
          { label: "การแสดงช่องทางโซเชียลของสาขา", text: "แสดงข้อมูลโปรไฟล์ @username และสถิติที่ได้รับอนุญาตบนหน้ารายละเอียดสาขา (Store Directory) เพื่อให้ลูกค้าเข้าถึงช่องทางทางการได้อย่างมั่นใจ" },
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          { label: "Video count & public metrics", text: "Total public video count on the account (video count). The service does not store raw video files and does not request video.list or content posting scopes (granular individual video metrics such as video views, video likes, comments, and shares are not collected)." },
      ...
      },
      {
        ...
        bullets: [
          { label: "Public store social profile", text: "Displaying verified TikTok @username and authorized reach statistics on the public store directory to help customers discover official store channels." },
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          { label: "视频数量与公开指标", text: "账户已发布的公开视频总数 (Video Count)。系统不存储原始视频文件，亦不请求 video.list 或内容发布权限（不采集单条视频维度的 video views、video likes、comments 或 shares）。" },
      ...
      },
      {
        ...
        bullets: [
          { label: "门店公开社交主页展示", text: "在公开门店名录中展示经认证的 TikTok @username 及授权的触达指标，帮助顾客找到官方门店渠道。" },
