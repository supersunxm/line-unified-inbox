...
export const translations: Record<Language, MassMessagesText> = {
  th: {
    ...
    imageUploadHelper: "รองรับ JPG, PNG, WEBP (ขนาดไม่เกิน 10 MB, สูงสุด 1 รูป)",
    ...
    imageInvalidFormat: "รูปแบบไฟล์ไม่ถูกต้อง รองรับเฉพาะ JPG, PNG, WEBP",
  ...
  en: {
    ...
    imageUploadHelper: "Supports JPG, PNG, WEBP (Max 10 MB, 1 image max)",
    uploadingImage: "Uploading image...",
    imageUploadFailed: "Failed to upload image. Please try again.",
    imageTooLarge: "Image exceeds 10 MB limit",
    imageInvalidFormat: "Invalid format. Only JPG, PNG, and WebP are supported.",
  ...
  zh: {
    ...
    imageUploadHelper: "支持 JPG, PNG, WEBP（最大 10 MB，限 1 张）",
    uploadingImage: "正在上传图片...",
    imageUploadFailed: "图片上传失败，请重试",
    imageTooLarge: "图片大小超过 10 MB 限制",
    imageInvalidFormat: "格式不受支持，仅支持 JPG、PNG、WebP",
