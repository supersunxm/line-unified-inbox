INSERT INTO "AppRelease" (
  ...
  'app-release-android-1-1-5-25', 'ANDROID', '1.1.5', 25,
  '1.0.3', 4, false,
  'https://lineoppo.click/downloads/oppo-line-oa-chat-v1.1.5-production.apk?sha=5e20a9361014dc292715cee0eaede6b84582d2f881cd9ffe23e1d49442fcdae2',
  '59.8 MB', '5e20a9361014dc292715cee0eaede6b84582d2f881cd9ffe23e1d49442fcdae2',
  ARRAY[
...
WHERE "platform" = 'ANDROID' AND "buildNumber" < 25;
