...
const valid = { NODE_ENV: "production", DATABASE_URL: "postgresql://user:password@host/db", FRONTEND_URL: "http://localhost:3000", PUBLIC_WEBHOOK_BASE_URL: "https://example.up.railway.app", LINE_CREDENTIAL_ENCRYPTION_KEY: Buffer.alloc(32, 7).toString("base64"), LINE_WEBHOOK_ENABLED: "true", PILOT_MODE: "true", PILOT_ADMIN_BOOTSTRAP_ENABLED: "false", EMAIL_PROVIDER: "none", DEV_ADMIN_ENABLED: "false" };
