...
void test("conversation returns only the canonical manager URL and excludes chat and credential fields", async () => {
  ...
  const conversation = {
    ...
    messages: [{ id: "sticker-1", conversationId: "conversation-1", externalMessageId: "line-sticker-1", direction: "INBOUND", messageType: "STICKER", originalText: "ส่งสติกเกอร์ LINE", originalLanguage: null, translatedThai: null, translatedEnglish: null, translatedChinese: null, rawPayload: { type: "sticker", packageId: "11537", stickerId: "52002738", keywords: ["ขอบคุณ"] }, senderUserId: null, senderDisplayName: null, fileName: null, latitude: null, longitude: null, encryptedLineReplyToken: null, lineReplyTokenReceivedAt: null, lineReplyTokenUsedAt: null, sentAt: new Date(), createdAt: new Date(), sender: null, media: null }], products: [], topics: [], notes: [], activityHistory: [],
  };
